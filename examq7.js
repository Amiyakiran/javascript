var restaurants= [
     {    "id": 1,
          ...
          "reviews": [ {"name": "Steve",
                       ...
                       },
                       {
                        ...
                        "date": "October 26, 2016",
                        "rating": 3.5,
                        "comments": "This place is a blast. Must orders: GREEN TEANOODS, sounds gross (to me at least) but these were incredible!, Kungpao pastrami (but you already knew that), beef tartare was a fun appetizer that we decided to try, the spicy ma po tofu SUPER spicy but delicous, egg rolls and scallion pancake i could have passed on... I  wish we would have gone with a larger group, so much more I would have  liked to try!"
                      },
                    {
                        "name": "Jason",
                        "date": "October 26, 2016",
    ...
    {        "id": 5,
            "name": "Roberta's Pizza",
             "neighborhood": "Brooklyn",
             "photograph": "https://images.unsplash.com/photo-1520201163981- 8cc95007dd2a?ixlib=rb1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit =crop&w=1534&q=80",
    ...
    },
    {
                ...
                "name": "Hometown BBQ",
                 "neighborhood": "Brooklyn",
                "photograph": "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?ixlib=rb1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1534&q=80",
    ...
    },
    {
                ...
                "neighborhood": "Manhattan",
                "photograph": "https://images.unsplash.com/photo-1565060299583- 08dd3af8e3cb?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb -1.2.1&auto=format&fit=crop&w=1533&q=80",
    ...
    },
    {
                ...
                "name": "The Dutch",
                 "neighborhood": "Manhattan",
                "photograph": "https://images.unsplash.com/photo-1611171711791-b34fa42e9fc2?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1534&q=80",
    ...
    },
    {
                  ...
                  "name": "Mu Ramen",
                  "neighborhood": "Queens",
                  "photograph": "https://images.unsplash.com/photo-1511910849309-0dffb8785146?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb -1.2.1&auto=format&fit=crop&w=1534&q=80",
    ...
    
    {
                 ...
                 "name": "Casa Enrique",
                 "neighborhood": "Queens",
                 "photograph": "https://images.unsplash.com/photo-1624300629298- e9de39c13be5?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1534&q=80",
...
// a. Display all restaurants name
 console.log("Name of all restaurants : ");
 restaurants.map(item=>item['name']).forEach(item=>console.log(item))
 console.log("----------------------------");
// b. Display the operating hours of restaurant id:4
console.log("operating hours of restaurant id:4");
restaurants.filter(item=>item.id== 4).forEach(item=>console.log(item["operating_hours"]))
console.log("----------------------------");

// c. Display the comments provided by customer Steph for restaurant Emily
console.log("comments provided by customer Steph for restaurant Emily: ");
console.log(restaurants.map(item=> item.reviews).flat().filter(item=>item.name=="Steph").forEach(item=>console.log(item["comments"])));
console.log("----------------------------");

// d. Display all restaurants name whose cuisine_type is Asian
console.log("Display all restaurants name whose cuisine_type is Asian: ");
restaurants.filter(item=>item.cuisine_type=="Asian").forEach(item=>console.log(item["name"]))
console.log("----------------------------");


// e. Display all restaurants whose neighborhood is Brooklyn
console.log(" Display all restaurants whose neighborhood is Brooklyn: ");
restaurants.filter(item=>item.neighborhood=="Brooklyn").forEach(item=>console.log(item["name"]))
